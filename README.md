...
For more information about installation and how it works, check: ### [Documentation](https://github.com/space-ninja-x/The-Bell-App/blob/main/Documentation)


And to download the setup file for Windows, check: ### [Windows Installer](https://drive.google.com/file/d/1od9eRTVmAI4sleBtNstq7DpctqraZOP_/view?usp=sharing)
