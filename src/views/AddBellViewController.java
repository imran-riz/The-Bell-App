...
public class AddBellViewController implements Initializable
{
    ...
    private void initialiseBoxes()
    {
        ...
        listOfRepeatValues.addAll(Repeat.NONE, Repeat.EVERY_WEEK, Repeat.EVERY_MONDAY, Repeat.EVERY_TUESDAY, Repeat.EVERY_WEDNESDAY, Repeat.EVERY_THURSDAY, Repeat.EVERY_FRIDAY) ;
    ...
    /**
     * Method to get the starting time set
    ...
    /**
     * Method to get the end time set
     * @return The end time in the format HH:MM
     */
    ...
    {
        String description = "-" ;
        String val = Repeat.NONE;

        switch (repeatBox.getValue())
        {
            case "EVERY WEEK":
                val = Repeat.EVERY_WEEK ;
                break ;
            case "EVERY MONDAY":
                val = Repeat.EVERY_MONDAY ;
                break ;
            case "EVERY TUESDAY":
                val = Repeat.EVERY_TUESDAY ;
                break ;
            case "EVERY WEDNESDAY":
                val = Repeat.EVERY_WEDNESDAY ;
                break ;
            case "EVERY THURSDAY":
                val = Repeat.EVERY_THURSDAY ;
                break ;
            case "EVERY FRIDAY":
                val = Repeat.EVERY_FRIDAY ;
                break ;
        }
        ...
        if(!checkBox.isSelected())
        {
            ...
            else
            {
                ...
                {
                    period = Integer.parseInt(this.periodField.getText());

                    if(periodChoiceBox.getValue().equals("Minutes"))    period = period * 60;
                }
