...
public class HomeViewController implements Initializable
{
    ...
    public TableColumn<Bell, String> bellIDCol, startTimeCol, endTimeCol, periodCol, statusCol, repeatCol;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle)
    {
        ...
        Timeline timeline = new Timeline(new KeyFrame(Duration.seconds(1), event -> this.tableView.refresh())) ;
