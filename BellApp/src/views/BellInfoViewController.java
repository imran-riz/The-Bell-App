...
public class BellInfoViewController implements Initializable
{
    ...
    public void initialize(URL url, ResourceBundle resourceBundle)
    {
        ...
        {
            this.warning.setText("Audio file is not found! Select another.");
        }
    ...
    public void action()
    {
        if(actionBtn.getText().equalsIgnoreCase("Pause"))
        {
            HomeViewController.selectedBell.pause() ;
            ((Stage) this.root.getScene().getWindow()).close() ;
        }
        else if(actionBtn.getText().equalsIgnoreCase("Reset"))
        {
