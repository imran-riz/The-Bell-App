...
public class Bell implements Serializable
{
    ...
    private int periodInSeconds, delayInSeconds ;
     ...
     */
    public Bell(String id, String startTime, String endTime, int periodInSeconds, String repeat, String path, String description)
    {
        this.bellID = id ;
        ...
        {
            this.period = Integer.toString(periodInSeconds / 60) ;
        ...
        {
            this.period = Integer.toString(periodInSeconds) ;
    ...
    private void setTheTimer()
    {
        ...
        timerTask = new TimerTask()
        {
            ...
            public void run()
            {
                ...
                System.out.println("\nBellID: " + bellID);
                System.out.println("endTimeInSeconds = " + endTimeInSeconds + " | currentTimeInSeconds = " + currentTimeInSeconds) ;
        ...
        if(this.periodInSeconds > 0)
            this.timer.schedule(timerTask, (this.delayInSeconds * 1000L), (this.periodInSeconds * 1000L)) ;
        else
    ...
    /**
     * Cancels the Timer and TimerTask and updates the status of the bell
     */
    public void pause()
    {
        if(this.timerTask != null)
    ...
    private Boolean playToday()
    {
        ...
        {
            if(this.repeat.equals(Repeat.EVERY_WEEK))
            {
                play = true ;
            }
            else
            {
                String dayToRepeatOn = this.repeat.substring(7) ;
