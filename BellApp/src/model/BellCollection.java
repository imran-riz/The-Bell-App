...
public class BellCollection
{
     ...
     */
    public void addNewBell(String bellID, String startTime, String endTime, double periodInSeconds, String repeat, String path, String description) throws Exception
    {
